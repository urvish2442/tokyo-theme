...
function ThemesCustomization() {
  ...
  return (
    <>
      <Head>
        <title>
          Themes Customization - Tokyo Black NextJS Javascript Admin Dashboard
        </title>
      </Head>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              Tokyo Black NextJS Javascript Admin Dashboard comes with 3
            ...
            <Typography paragraph>
              ...
              <code>src\theme\schemes\NebulaFighterTheme.js</code>:
            </Typography>
            <Prism
              showLineNumbers
              wrapLines
