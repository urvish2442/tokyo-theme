...
function Dependencies() {
  return (
    <>
      <Head>
        <title>
          Dependencies - Tokyo Black NextJS Javascript Admin Dashboard
        </title>
      </Head>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              At it's core, Tokyo Black NextJS Javascript Admin Dashboard is
              powered by <code>React</code>, <code>Javascript</code>,{' '}
