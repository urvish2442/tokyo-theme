...
function RtlLayout() {
  ...
  return (
    <>
      <Head>
        <title>
          Right-to-Left Layout - Tokyo Black NextJS Javascript Admin Dashboard
        </title>
      </Head>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12}>
            <Typography paragraph>
              Tokyo Black NextJS Javascript Admin Dashboard fully supports
            ...
            <Typography paragraph>
              ...
              <code>src\theme\schemes\NebulaFighterTheme.js</code>) you will
